...
if($_POST['name']){ // заносим в массив значение полей, их может быть больше
  ...
  mail("info@hk-design.com.ua", "Форма УЗНАЙТЕ, ПОЧЕМУ КЛИЕНТАМ ТАК НРАВИТСЯ РАБОТАТЬ С НАМИ  ".$_SERVER['HTTP_REFERER'], $znach[1]." ".$znach[2]." ".$znach[3]); // письмо на свой электронный ящик, измените на свой email
}
