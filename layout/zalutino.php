...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/zalutino/zalutino1.jpg" alt="Image 1" />
      <img src="../img/zalutino/zalutino2.jpg" alt="Image 1" />
      <img src="../img/zalutino/zalutino3.jpg" alt="Image 1" />
      <img src="../img/zalutino/zalutino4.jpg" alt="Image 1" />
      <img src="../img/zalutino/zalutino5.jpg" alt="Image 1" />
      <img src="../img/zalutino/zalutino6.jpg" alt="Image 1" />
    ...
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Залютино</h2>
        <p>Дом 1300кв.м Всего в доме проживает 5 чел. Перед дизайнерами студии стояла сложная задача раз раб дизайн, которій віражал харакре и пожелания каждого.  Не смотря на разность дизайна в каждой комнате дом объединен по цветовой гамме и сочетание материалов.</p>
