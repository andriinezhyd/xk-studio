...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/aqua/aqua1.jpg" alt="Image 1" />
      <img src="../img/aqua/aqua2.jpg" alt="Image 1" />
      <img src="../img/aqua/aqua3.jpg" alt="Image 1" />
      <img src="../img/aqua/aqua4.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Акварели</h2>
        <p>Легкость и воздушность  определяет этот интерьер . Роскошная квартира общей площадью 94 кв.м.,  дизайнеры студии при разработке дизайна использовали светлые тона и настенные панно. В интерьере используется сочетание глянцевых и матовых материалов. Особый акцент в интерьере вносит живая стена.</p>
