...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/arch/arch1.jpg" alt="Image 1" />
      <img src="../img/arch/arch2.jpg" alt="Image 1" />
      <img src="../img/arch/arch3.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Архитектура</h2>
        <p>Архитектура проект загородного дома общей площадью 340 кв.м. Дом находится в Печенегах , 60 км от Харькова, поэтому особое влияние на проект оказала топографическая структура участка. В основу проекта  был взят современный стиль.  За счет больших окон и пересекающихся архитектурных объемов, создается неповторимое восприятие обычных прямоугольных форм.</p>
