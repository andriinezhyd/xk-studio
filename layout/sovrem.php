...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/sovrem/sovrem1.jpg" alt="Image 1" />
      <img src="../img/sovrem/sovrem2.jpg" alt="Image 1" />
      <img src="../img/sovrem/sovrem3.jpg" alt="Image 1" />
      <img src="../img/sovrem/sovrem4.jpg" alt="Image 1" />
      <img src="../img/sovrem/sovrem5.jpg" alt="Image 1" />
      <img src="../img/sovrem/sovrem6.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Современный стиль</h2>
        <p>Дизайн разработан для молодой пары. Оригинальность и функциональность пространства были основными требованиями. Дизайнеры студии предложили попробовать реализовать самые смелые колористические пожелания. И благодаря тесному сотрудничеству дизайнера и клиента получился интерьер, который в точности выражает характер владельцев.</p>
