...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/robert/robert3.jpg" alt="Image 1" />
      <img src="../img/robert/robert2.jpg" alt="Image 1" />
      <img src="../img/robert/robert1.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
     <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Robert Clay</h2>
        <p>Создано концептуальное  фешен-пространство, которое презентует и помогает продавать одежду бренда. Дизайн разработан с учетом маркетинга-продаж, он распологает клиента к покупке.</p>
