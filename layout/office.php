<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/office/office1.jpg" alt="Image 1" />
      <img src="../img/office/office2.jpg" alt="Image 1" />
      <img src="../img/office/office3.jpg" alt="Image 1" />
      <img src="../img/office/office4.jpg" alt="Image 1" />
      <img src="../img/office/office5.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
     <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Офис</h2>
        <p>Офис для it-компании оформлен в современном стиле.  Используются такие материалы как стекло, мдф, бетон.  Особенность интерьера заключается в том, что вся мебель стоит максимально плотно для большего количества рабочих мест, при этом отлично функционирует. Удобство и эргономика - основные критерии при оформлении рабочих зон.</p>
