...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/apart/apart1.jpg" alt="Image 1" />
      <img src="../img/apart/apart2.jpg" alt="Image 1" />
      <img src="../img/apart/apart3.jpg" alt="Image 1" />
      <img src="../img/apart/apart4.jpg" alt="Image 1" />
      <img src="../img/apart/apart5.jpg" alt="Image 1" />
      <img src="../img/apart/apart6.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Апартаменты</h2>
        <p>Создание авторских апартаментов  для отеля в Хорватии которые подчёркивают индивидуальный стиль отеля  Pavlo Napa Beach Hotel и создает незабываемое впечатление у посетителей и гостей. В дизайне применены дорогие материалы позолота, мрамор и добавлен эко стиль с живой стеной.</p>
