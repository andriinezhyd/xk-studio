...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/berlin/berlin1.jpg" alt="Image 1"  />
      <img src="../img/berlin/berlin2.jpg" alt="Image 1"  />
      <img src="../img/berlin/berlin3.jpg" alt="Image 1"  />
      <img src="../img/berlin/berlin9.jpg" alt="Image 1"  />
      <img src="../img/berlin/berlin11.jpg" alt="Image 1" />
      <img src="../img/berlin/berlin12.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Berlin House</h2>
        <p>Роскошная квартира в современном стиле, где использовались последние тенденции и наработки. Основной акцент сделан на теплых цветах (желтый и светло коричневый), для придания интерьеру поистине домашнего уюта. Для декора стен  взята выпуклая плитка и порезанное зеркало различных геометрических форм, что визуально расширило пространство.</p>
