...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/tobol/tobol1.jpg" alt="Image 1" />
      <img src="../img/tobol/tobol2.jpg" alt="Image 1" />
      <img src="../img/tobol/tobol3.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Тобольская</h2>
        <p>Цель проекта - маленькая квартира с большим функционалом. Общая площадь квартиры  32 кв.м, где мы смогли соединить полноценную спальню, кухню-гостиную , гардеробную и достаточно функциональную ванную комнату. За счет светлых стен визуально расширилось пространство. Благодаря теплым материалам, таких как кирпич, мдф шпонированный под натуральный дуб, создается приятная теплая атмосфера.</p>
