...
<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/lullaby-bakery/bakery1.jpg" alt="Image 1" />
      <img src="../img/lullaby-bakery/bakery2.jpg" alt="Image 2" />
      <img src="../img/lullaby-bakery/bakery3.jpg" alt="Image 3" />
      <img src="../img/lullaby-bakery/bakery4.jpg" alt="Image 4" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Bakery</h2>
        <p>Основной задачей проекта было создание приятного пространства, которое рассчитано на американский рынок. Целевыми потребителями стали семейные пары с детьми, поэтому в пространстве используется только натуральные материалы. Основной акцент ставился на создание уюта, для этого были разработаны перегородки, которые отделяют одну зону от другой. Конверсия после реализации увеличилась на 34%.</p>
