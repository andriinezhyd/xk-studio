<html>
    ...
    <div id="tf_bg" class="tf_bg">
      <img src="../img/shatilovka/shatilovka1.jpg" alt="Image 1" />
      <img src="../img/shatilovka/shatilovka2.jpg" alt="Image 1" />
      <img src="../img/shatilovka/shatilovka3.jpg" alt="Image 1" />
      <img src="../img/shatilovka/shatilovka4.jpg" alt="Image 1" />
      <img src="../img/shatilovka/shatilovka5.jpg" alt="Image 1" />
      <img src="../img/shatilovka/shatilovka6.jpg" alt="Image 1" />
      <?php include('../partials/menu.php')?>
    </div>
    <div id="tf_content_wrapper" class="tf_content_wrapper">
      <div class="tf_content" id="content1" style="display:block;">
        <h2>Шатиловка</h2>
        <p>Общая площадь данного проекта составляет 94 кв.м в основу дизайнерского решения было положено использование контрастных оттенков и современных материалов. Монохромность палитры придает данному интерьеру фамильной статустности и изысканности. Современные материалы и светильник от Chandelier by Roll & Hill придает роскошь пространству. </p>
